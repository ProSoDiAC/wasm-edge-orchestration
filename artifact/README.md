...
| Pod-resource figure | `figures/pod_resources_bar.png` | `scripts/generate_paper_figures.py` |
...
| Wire-size figure | `figures/wire_sizes_bar.png` (in this package) | `scripts/generate_wire_sizes_figure.py` |
