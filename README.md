...
This repository carries the implementation and the measurement records behind
the accompanying paper. The paper itself is distributed by the journal; every
number it reports is reproduced here from the record that produced it.

| | |
|---|---|
| Records behind every reported number | `artifact/` (start at `artifact/README.md`) |
| Reported campaign | `experiments/20260821-083420/` |
| Published figures | `artifact/figures/`, `artifact/campaign/figures/` |
